            ...
            <div className="final-inner">
                ...
                {phase === 'wager' && (
                    <div className="card">
                        ...
                        <p className="hint-text" style={{marginBottom: '1rem'}}>Place your wager before the question is
                            revealed.</p>
                ...
                {phase === 'answer' && (
                    <div className="card">
                        ...
                        <div className="modal-question"
                             style={{fontSize: '1.3rem', marginBottom: '1.5rem'}}>{question}</div>
                        ...
                        {reveal.map((r, i) => {
                            ...
                            return (
                                <div key={i} className={`reveal-row ${r.correct ? 'correct' : 'wrong'}`}>
                                    ...
                                    <span
                                        className={`reveal-delta ${r.correct ? 'ok' : 'bad'}`}>{sign}${r.delta.toLocaleString()}</span>
                                </div>
                            )
                        })}
