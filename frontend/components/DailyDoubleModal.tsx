  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-box" style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '0.8rem', color: 'var(--gray)', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '1rem' }}>
          {category} — ${value}
        </div>
        ...
        {phase === 'answer' && (
          <>
            <div style={{ fontSize: '0.8rem', color: 'var(--gray)', marginBottom: '0.5rem' }}>Wager: ${confirmedWager.toLocaleString()}</div>
